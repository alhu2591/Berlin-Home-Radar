  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        <ScreenHeader title="Settings" subtitle="Preferences, storage, source management, and runtime." />
        ...
        <Section title="Data & cache">
          ...
          <View style={styles.actions}>
            ...
            <Button label="Reset cache & diagnostics" variant="ghost" onPress={() => Alert.alert('Reset local data', 'This clears cached listings, analytics counters, dismissed items, and alert history.', [{ text: 'Cancel', style: 'cancel' }, { text: 'Reset', style: 'destructive', onPress: () => { void clearAppData(); } }])} fullWidth />
          </View>
        </Section>
      </ScrollView>
    </SafeAreaView>
